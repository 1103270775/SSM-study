        ...
        <div class="modal-body">
            <form action="/add_user.do" method="post">
                <div class="input-group">
                    ...
                    <input readonly id="uid" name="uid" value="${requestScope.user.uid}" type="text" class="form-control" placeholder="用户编号由系统决定" aria-describedby="basic-addon1">
                </div>
                ...
                <div class="input-group">
                    ...
                    <input id="username" name="username" value="${requestScope.user.username}" type="text" class="form-control" placeholder="用户名" aria-describedby="basic-addon2">
                </div>
